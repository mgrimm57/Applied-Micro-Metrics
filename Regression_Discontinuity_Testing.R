...
# graph showing the impact of different bandwidths
...
plot_0.05 <- ggplot(aes(reportwealth1), data = p2) + geom_density(bw=0.05, col = "green") + 
...
# crude test for smoothness around the cutoff for wealth1
...
# crude test for smoothness around the cutoff for wealth2
...
# crude test for smoothness around the cutoff for wealth3
...
# crude test for smoothness around the cutoff for wealth4
...
# altering the wealth using dummy and some noise
...
# function to run multiple RD regressions
...
# a more robsut regression disontinuity design
